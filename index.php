                            ...
                            <div class="card border-0">
                                <div class="card-header">
                                    <div class="edit-profile__title">
                                        <h6>¡Bienvenido al Challenge TopTen!</h6>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="edit-profile__body">
                                        <div class="form-group mb-25">
                                            ...
                                            <input type="text" class="form-control" id="username" placeholder="correo@ejemplo.com">
                                        </div>
                                        ...
                                        <div class="admin-condition">
                                            ...
                                            <a href="forget-password.html" class="text-info">¿Olvido su contraseña?</a>
                                        </div>
                                        <div class="admin__button-group button-group d-flex pt-1 justify-content-md-start justify-content-center">
                                            <button class="btn btn-info btn-default w-100 btn-squared text-capitalize lh-normal px-50 signIn-createBtn ">
                                                Iniciar sesión <i class="ms-2 fas fa-arrow-right"></i>
                                            </button>
                                        </div>

                                        <p class="social-connector social-connector__admin text-center my-3">
                                            <span>Ó</span>
                                        </p>

                                        <div class="admin__button-group button-group d-flex pt-1 justify-content-md-start justify-content-center">
                                            <a href="registro.php" class="btn btn-outline-info btn-default w-100 btn-squared text-capitalize lh-normal px-50 signIn-createBtn ">
