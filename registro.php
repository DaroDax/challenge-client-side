...
<head>
    ...
    <title>Challenge TopTen - Iniciar Sesión</title>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6 col-sm-8">
                        <div class="edit-profile">
                            <div class="edit-profile__logos">
                                <a href="index.html">
                                    <img class="dark" src="img/topten-1024x484-black.png" alt="">
                                    <img class="light" src="img/topten-1024x484-white.png" alt="">
                                </a>
                            </div>
                            <div class="card border-0">
                                <div class="card-header">
                                    <div class="edit-profile__title">
                                        <h6>¡Registrar nuevo Challenger!</h6>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="edit-profile__body">
                                        <div class="edit-profile__body">
                                            <div class="form-group mb-20">
                                                ...
                                                <input type="text" class="form-control" id="name" placeholder="30100200">
                                            </div>
                                            ...
                                            <div class="form-group mb-20">
                                                ...
                                                <input type="text" class="form-control" id="username" placeholder="jhDoe">
                                            </div>
                                            <div class="form-group mb-20">
                                                <label for="email">Email</label>
                                                <input type="text" class="form-control" id="email" placeholder="ejemplo@gmail.com">
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-4">
                                                        ...
                                                        <select name="select-size-1" id="select-size-1" class="form-control  form-control-lg">
                                                            <option value="01">+58 COL</option>
                                                            <option value="01">+57 VE</option>
                                                            <option value="01">+56 MEX</option>
                                                        </select>
                                                    </div>

                                                    <div class="col-8">
                                                        <label for="email">Telefono (Whatsapp)</label>
                                                        <input type="text" class="form-control" id="email" placeholder="30020010000">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="admin__button-group button-group d-flex pt-3 justify-content-md-start justify-content-center">
                                                <button class="btn btn-info btn-default w-100 btn-squared text-capitalize lh-normal px-50 signIn-createBtn ">
                                                    Completar Registro
                                                    <i class="ms-2 uil uil-save"></i>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
